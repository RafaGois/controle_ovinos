...
<div className="h-20 w-full bg-white dark:bg-gradient-to-r dark:from-[#0a3d63] dark:to-[#5982a1] flex items-center justify-evenly rounded-br-3xl shadow-sm">
        <Image src={theme === 'dark' ? "/iconePreto.png" : "/iconeBranco.png"} alt="logo" width={150} height={50} />
      ...
      <ul className="flex flex-col flex-grow overflow-y-auto mt-4 gap-2">
        <MenuItem url="/" text="Atual" icon={<MdSpaceDashboard size={20} />} type="normal" />
        <MenuItem url="/" text="Atual" icon={<BiSolidSpreadsheet size={20} />} type="normal" />
      </ul>
      <ul>
        <MenuItem
          url="/Autenticacao"
